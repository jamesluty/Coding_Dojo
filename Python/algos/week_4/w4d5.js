...
function lowestCommonMultiple(a, b, low=Math.min(a,b), high=Math.max(a,b)) {
    if (high % low === 0) return high;

    return lowestCommonMultiple(a, b, low, high+=Math.max(a,b))
}
...
// function binaryStringExpansion(str, output = [], i= 0) {
//     if ( i == 0 ) {
//         newOutput = str.replaceAll("?", "0")
//         output.push(newOutput)
//         newOutput = str.replaceAll("?", "1")
//         output.push(newOutput)
//     } else if ( i == 1){
//         newOutput = str.replace("?","0").replace("?", "1")
//         output.push(newOutput)
//         newOutput = str.replace("?","1").replace("?", "0")
//         output.push(newOutput)
//     }
...
//     return binaryStringExpansion(str, output, ++i)
// }
